...
from posts_service import db  # Asegúrate de importar el db de tu servicio de posts
from posts_service.models.posts import Post
from flask import current_app
import logging

# Configura el logger para enviar los logs al servicio de logs, si es necesario
