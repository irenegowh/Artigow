# votes.py
from votes_service import db  # Importa la instancia de SQLAlchemy desde app.py
...
class Vote(db.Model):
    ...
    user_id = db.Column(db.Integer, ForeignKey("userprof.id"), nullable=False)  # Aquí se asegura la FK a UserProf
